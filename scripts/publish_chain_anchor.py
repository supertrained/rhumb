...
Options:
    --streams score_audit_chain,audit_events,billing_events,execution_receipts
...
DEFAULT_STREAMS = ["score_audit_chain", "audit_events", "billing_events", "execution_receipts"]
