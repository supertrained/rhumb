...
export const metadata: Metadata = {
  ...
  other: {
    ...
    "ai:activation": "npx rhumb-mcp@latest",
    "ai:payment-protocol": "x402",
    "ai:payment-currency": "USDC",
    "ai:signup-required": "depends_on_rail",
    "ai:free-tier": "Discovery, scoring, and browsing",
  },
  openGraph: {
    type: "website",
    siteName: "Rhumb",
  ...
  offers: [
    {
      ...
      price: "0",
      priceCurrency: "USD",
      description: "Discovery, scoring, and browsing are free.",
    },
    {
      "@type": "Offer",
