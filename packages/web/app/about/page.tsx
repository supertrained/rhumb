        ...
        <header className="mb-16">
          ...
          <div className="mt-8 rounded-2xl border border-amber/20 bg-surface/80 p-5 backdrop-blur-sm">
            <p className="text-xs font-mono text-amber uppercase tracking-widest">
              Before you rely on Rhumb’s claims
            </p>
            <p className="mt-3 text-sm text-slate-400 leading-relaxed">
              Check the trust posture, scoring methodology, and dispute path first so the mission
              story stays anchored to the public evidence behind the score.
            </p>
