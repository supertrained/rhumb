...
-- Adds object.list, object.head, object.get to the capability registry.
-- These capabilities execute directly against AWS S3 via storage_ref,
...
-- AWS S3 read-first capabilities use direct execution via storage_ref.
-- No capability_services rows needed for the first read-only slice.
