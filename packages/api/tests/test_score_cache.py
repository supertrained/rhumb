...
class TestScoresV2Endpoints:
    ...
    def test_get_score_history_canonicalizes_alternate_provider_alias_text_for_alias_backed_rows(self, client):
        chain = get_audit_chain()
        chain.append(
            "brave-search",
            None,
            8.4,
            "brave-search improved after pdl comparison",
        )
    ...
    def test_get_score_history_canonicalizes_alternate_provider_alias_text_for_canonical_rows(self, client):
        chain = get_audit_chain()
        chain.append(
            "brave-search-api",
            None,
            8.4,
            "brave-search-api improved after pdl comparison",
        )
